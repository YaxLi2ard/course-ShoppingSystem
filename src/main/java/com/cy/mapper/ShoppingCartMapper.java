...
public interface ShoppingCartMapper {
     ...
     * @return
     */
    Integer selectCountById(@Param("userId") int userId, @Param("brandId") int brandId);
     ...
     * @return
     */
    List<Integer> selectBrandIds(@Param("id") int id);
     ...
     * @param count
     */
    void addCart(@Param("userId") int userId, @Param("brandId") int brandId, @Param("count") int count);
     ...
     * @param count
     */
    void updateCart(@Param("userId") int userId, @Param("brandId") int brandId, @Param("count") int count);
